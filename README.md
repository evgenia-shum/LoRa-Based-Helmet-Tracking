...
В модуле используются GPS-приемник для получения координат на открытой местности и гироскоп с акселерометром (LSM6DS3) для обнаружения падения, ударов. Процессором является микроконтроллер STM32F401CE. Также есть элементы индикации.
<img width="821" height="462" alt="стр1 drawio" src="https://github.com/user-attachments/assets/e7af5812-cc5e-4ea5-a4b3-5ce9ce237c76" />
